...
set JARPATH=%APP_HOME%\lib\construction-quantities-0.0.1-SNAPSHOT.jar

@rem Execute construction-quantities
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CONSTRUCTION_QUANTITIES_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%CONSTRUCTION_QUANTITIES_EXIT_CONSOLE%" exit 1
exit /b 1
